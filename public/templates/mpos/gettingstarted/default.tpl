<article class="module width_full">
  ...
  <div class="module_content">
    ...
    <li>4. <strong>配置您的挖矿软件.( 有任何问题请联系群里技术支持解决 )</strong>
      <ul>
        <li>
          ...
          <p>本矿池的配置参数如下: ( 下载的配置文件中已经初始化好，只要修改用户名.矿工名和密码 ).</p>
          <p>上述都修改完后，直接运行 cgminer.exe 即可开始挖矿</p>
        </li>
          <table width="50%">
            <tbody>
    ...
    <li>5. <strong>添加火币地址，以便我们及时提款给您</strong>
      <ul>
        <li> 下载火币钱包客户端，<a href="{$SITECOINURL|default:"http://www.firecoin.cc/"}" target="_blank">火币钱包下载</a>.
          <p>生成一个火币地址然后绑定到您的个人账户上.</p>
        </li>
      </ul>
    </li>
  </div>
