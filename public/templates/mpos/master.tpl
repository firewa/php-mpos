...
<head>
  ...
  <meta name="keywords" content="火币矿池 矿池  爱挖矿 火币 FireCoin" />
  <meta name="description" content="{$GLOBAL.website.title},中国最好的火币矿池,专业指导，矿工停机实时通知，24小时随时提款。"/>
  ...
  <!--[if IE 7]><link rel="stylesheet" href="css/fontello-ie7.css"><![endif]-->
	...
	<![endif]-->
	<script type="text/javascript" src="{$PATH}/js/jquery.min.js" type="text/javascript"></script>
	<script type="text/javascript" src="{$PATH}/js/jquery-migrate.min.js" type="text/javascript"></script>
  ...
  <script type="text/javascript" src="{$PATH}/js/raphael-min.js"></script>
